            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                else
                {
                    ...
                    if (databaseValues.Budget != clientValues.Budget)
                        ModelState.AddModelError("Budget", "Current value: " + databaseValues.Budget.ToString("c"));
                    if (databaseValues.StartDate != clientValues.StartDate)
                        ModelState.AddModelError("StartDate", "Current value: " + databaseValues.StartDate.ToString("d"));
